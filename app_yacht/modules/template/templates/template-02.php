                                                        ...
                                                        <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="border-spacing: 0; border-collapse: collapse;">
                                                            <tr>
                                                                ...
                                                                <td align="right" valign="middle" style="text-align: right; color: #ffffff;">
                                                                    €<?php echo htmlspecialchars(number_format(floatval(str_replace([',','€',' '], '', $resultData['calculatedBaseRate'])), 0, '.', ',')); ?><?php echo (isset($templateData['enableExpenses']) && $templateData['enableExpenses']) ? ' + Expenses' : ''; ?>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                            ...
                                            <?php if (empty($templateData['hideElements']['hideVAT']) && !empty($resultData['vatRateForDisplay']) && floatval($resultData['vatRateForDisplay']) > 0
                                                ...
                                                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" valign="middle" style="padding: 5px; text-align: right; color: #4b4f54;">
                                                            €<?php echo htmlspecialchars(number_format(floatval(str_replace([',','€',' '], '', $resultData['vatDisplay'])), 0, '.', ',')); ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            <?php endif; ?>
                                            ...
                                            <?php if (empty($templateData['hideElements']['hideAPA']) && !empty($resultData['apaRateForDisplay']) && floatval($resultData['apaRateForDisplay']) > 0
                                                ...
                                                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" valign="middle" style="padding: 5px; text-align: right; color: #4b4f54;">
                                                            €<?php echo htmlspecialchars(number_format(floatval(str_replace([',','€',' '], '', $resultData['apaPercDisplay'])), 0, '.', ',')); ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            <?php endif; ?>
                                            ...
                                            <?php if (empty($templateData['hideElements']['hideAPA']) && !empty($resultData['apaAmountDisplay']) 
                                                ...
                                                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" valign="middle" style="padding: 5px; text-align: right; color: #4b4f54;">
                                                            €<?php echo htmlspecialchars(number_format(floatval(str_replace([',','€',' '], '', $resultData['apaAmountDisplay'])), 0, '.', ',')); ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            <?php endif; ?>
                                            ...
                                            <?php if (empty($templateData['hideElements']['hideRelocation']) && !empty($resultData['relocationDisplay']) 
                                                ...
                                                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" valign="middle" style="padding: 5px; text-align: right; color: #4b4f54;">
                                                            €<?php echo htmlspecialchars(number_format(floatval(str_replace([',','€',' '], '', $resultData['relocationDisplay'])), 0, '.', ',')); ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            <?php endif; ?>
                                            ...
                                            <?php if (empty($templateData['hideElements']['hideSecurity']) && !empty($resultData['securityDisplay']) 
                                                ...
                                                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" valign="middle" style="padding: 5px; text-align: right; color: #4b4f54;">
                                                            €<?php echo htmlspecialchars(number_format(floatval(str_replace([',','€',' '], '', $resultData['securityDisplay'])), 0, '.', ',')); ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            <?php endif; ?>
                                                ...
                                                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="border-spacing: 0; border-collapse: collapse; background-color: #12323a; border-bottom: 5px solid #dbe68b; color: #ffffff; font-family: Arial, sans-serif; font-size: 12px; border-radius: 14px 0 25px 0;">
                                                    <tr>
                                                        ...
                                                        <td align="right" valign="middle" style="padding: 10px 15px; text-align: right; font-weight: bold;">
                                                            €<?php echo htmlspecialchars(number_format(floatval(str_replace([',','€',' '], '', $resultData['subtotal'])), 0, '.', ',')); ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            <?php endif; ?>
                                                    ...
                                                    <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" style="padding: 5px 10px; text-align: right;">
                                                                €<?php echo htmlspecialchars(number_format(floatval(str_replace([',','€',' '], '', $extra['cost'])), 0, '.', ',')); ?>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                <?php endforeach; ?>
                                                    ...
                                                    <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" style="padding: 10px 20px; text-align: right;">
                                                                €<?php echo htmlspecialchars(number_format(floatval(str_replace([',','€',' '], '', $resultData['grandTotal'])), 0, '.', ',')); ?>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                <?php endif; ?>
                                                ...
                                                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <?php foreach ($resultData['gratuityRates'] as $gratuity): ?>
                                                        <tr>
                                                            ...
                                                            <td align="right" style="padding: 5px 10px; text-align: right;">
                                                                €<?php echo htmlspecialchars(number_format(floatval(str_replace([',','€',' '], '', $gratuity['amount'])), 0, '.', ',')); ?>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </table>
