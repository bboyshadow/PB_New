...
function app_yacht_scripts() {
    if (is_page_template('app-yacht.php')) {
        ...
        wp_localize_script('mix-script', 'ajaxData', array('ajaxurl' => admin_url('admin-ajax.php'), 'nonce' => wp_create_nonce('mix_calculate_nonce')));
        wp_localize_script('calculator-script', 'ajaxCalculatorData', array('ajaxurl' => admin_url('admin-ajax.php'), 'nonce' => wp_create_nonce('calculate_nonce')));
        ...
        wp_localize_script('template-script', 'ajaxTemplateData', array('ajaxurl' => admin_url('admin-ajax.php'), 'nonce' => wp_create_nonce('template_nonce')));
        ...
        wp_localize_script('yacht-outlook-ajax', 'pbOutlookData', array('ajaxurl' => admin_url('admin-ajax.php'), 'nonce' => $outlook_nonce, 'timestamp' => time()));
        wp_localize_script('msp-signature-js', 'mspData', array('ajaxUrl' => admin_url('admin-ajax.php'), 'mspNonce' => wp_create_nonce('msp_nonce_action')));
    }
}
