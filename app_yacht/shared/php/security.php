...
function pb_sanitize_html_content($content) {
    ...
    $allowed_html = array(
        ...
        'table' => array('style' => true, 'border' => true, 'cellpadding' => true, 'cellspacing' => true),
        'tbody' => array(),
        'tr' => array('style' => true),
    ...
    $clean_content = preg_replace_callback('/href=(["\'])([^"\']*)(["\'])/i', function($matches) {
 ...
 */
function pb_log_security_event($user_id, $event_type, $details = []) {
